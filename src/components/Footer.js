    ...
    <footer className="footer-container">
      <div className="footer-content">
        ...
        <div className="footer-column">
          ...
          <p>
            Güven ve kaliteyle inşa ediyoruz. Hayalinizdeki yapılar için bizimle iletişime geçin.
          </p>
        </div>
        ...
        <div className="footer-column">
          ...
          <div className="social-icons">
            {/* Şimdilik buton, daha sonra buraya gerçek link koyabilirsin */}
            ...
            <button className="social youtube">
              <FaYoutube />
            </button>
            <a
              href="https://wa.me/905348586565?text=Merhabalar%2C%20projeleriniz%20hakkında%20bilgi%20almak%20istiyorum."
